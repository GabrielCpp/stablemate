...
class Browser:
    ...
    def open(self) -> Any:
        ...
        # this process was handed — and which is opt-in and Linux-only. Every other mode is
        # headless, including the default `viewport`: Playwright's own recorder films the
        # page whether or not there is a screen to draw it on.
