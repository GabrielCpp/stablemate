...
def cmd_import(args: argparse.Namespace) -> int:
    ...
    except ledger.RowError as bad:
        # The file is refused and the caller is told which line refused it, which is the
        # whole of what an import can do about a bad row. Reporting it is not a failure of
        # the import, so the command reports it and returns.
