...
@scenario(
    ...
    covers=[
        ...
        "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:1",
        "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:2",
...
def a_register_holds_the_claims_of_whoever_asked(qa: Qa) -> None:
    ...
    mine_body = mine.json()
    qa.verify("http_status", mine, code=200, path="/api/claims", covers=["ac:1", "okf:docs/features/claims/http/claims-api.md#list-claims:does:1"])
    ...
    qa.verify("json_path", mine_body, path="$.claims[0].status", matches="Submitted|Approved|Denied", covers=["ac:1", "okf:docs/features/claims/http/claims-api.md#list-claims:does:1", "okf:docs/features/claims/flows/file-a-claim.md:end:1"])
    qa.verify("count", mine_body["claims"], subject="claims", equals=1, covers=["ac:2", "okf:docs/features/claims/http/claims-api.md#list-claims:authorization:1", "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:1", "okf:docs/features/claims/flows/file-a-claim.md:end:1"])
    qa.verify("json_path", mine_body, path="$.claims[0].holder_uid", equals=who["a"]["uid"], covers=["ac:2", "okf:docs/features/claims/http/claims-api.md#list-claims:authorization:1", "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:1"])

    theirs = qa.http.get("/api/claims", headers=bearer(who["b"]), expect_status=200).json()["claims"]
    qa.verify("count", theirs, subject="claims", equals=1, covers=["ac:2", "okf:docs/features/claims/http/claims-api.md#list-claims:authorization:1", "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:1"])
    qa.check("the second holder is shown their own claim and not the first holder's", theirs[0]["id"] == "cl-1002" and theirs[0]["holder_uid"] == who["b"]["uid"], covers=["ac:2", "okf:docs/features/claims/concepts/claim-tenancy.md:contract", "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:1"])

    everything = qa.http.get("/api/claims", headers=bearer(who["adjuster"]), expect_status=200).json()["claims"]
    qa.verify("count", everything, subject="claims", equals=2, covers=["ac:1", "okf:docs/features/claims/http/claims-api.md#list-claims:authorization:2", "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:2"])
    qa.check("the adjuster's register is in the order the claims were written", [claim["id"] for claim in everything] == ["cl-1001", "cl-1002"], covers=["okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:2"])
    ...
    qa.verify("http_status", emptied, code=200, path="/api/claims", covers=["ac:4", "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:1"])
    qa.verify("count", emptied.json()["claims"], subject="claims", equals=0, covers=["ac:4", "okf:docs/features/claims/concepts/claim-tenancy.md#visibleto:returns:1"])
...
@scenario(
    ...
    covers=[
        ...
        "okf:docs/features/claims/concepts/claim-tenancy.md#entitled:returns:1",
    ],
    preconditions=[
...
def a_claim_answers_to_its_holder_and_to_an_adjuster(qa: Qa) -> None:
    ...
    qa.verify("http_status", owned, code=200, path="/api/claims/cl-1001", covers=["ac:3", "okf:docs/features/claims/http/claims-api.md#get-claim:does:1", "okf:docs/features/claims/concepts/claim-tenancy.md#entitled:returns:1"])
    ...
    qa.check("the claim the holder is shown is the one they filed", owned_body["claim"]["holder_uid"] == who["a"]["uid"], covers=["ac:3", "okf:docs/features/claims/concepts/claim-tenancy.md#entitled:returns:1"])

    overseen = qa.http.get("/api/claims/cl-1001", headers=bearer(who["adjuster"]), expect_status=200)
    qa.verify("http_status", overseen, code=200, path="/api/claims/cl-1001", covers=["ac:3", "okf:docs/features/claims/concepts/claim-tenancy.md#entitled:returns:1"])
    qa.verify("unchanged", (owned_body["claim"], overseen.json()["claim"]), subject="claim cl-1001", covers=["ac:3", "okf:docs/features/claims/concepts/claim-tenancy.md#entitled:returns:1"])
...
@scenario(
    ...
    covers=[
        ...
        "okf:docs/features/claims/concepts/claim-tenancy.md#entitled:returns:2",
    ],
    preconditions=[
...
def a_stranger_is_refused_differently_from_a_claim_that_is_not_there(qa: Qa) -> None:
    ...
    qa.verify("http_status", forbidden, code=403, title="Not Your Claim", path="/api/claims/cl-1002", covers=["ac:5", "okf:docs/features/claims/http/claims-api.md#get-claim:authorization:1", "okf:docs/features/claims/concepts/claim-tenancy.md#entitled:returns:2"])
