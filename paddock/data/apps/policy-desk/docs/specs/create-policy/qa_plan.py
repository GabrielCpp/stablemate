...
@scenario(
    ...
    covers=[
        ...
        "okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:contract", "okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:does:1", "okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:when:1",
        ...
        "okf:docs/features/policy/gui/screens/policy-detail.md#policy-heading:contract", "okf:docs/features/policy/gui/screens/policy-detail.md#policy-heading:keyboard:1", "okf:docs/features/policy/gui/screens/policy-detail.md#policy-heading:name:1", "okf:docs/features/policy/gui/screens/policy-detail.md#policy-heading:role:1",
    ],
...
def create_policy_browser_happy_path(qa: Qa) -> None:
    ...
    qa.verify("visible", heading, locator="../gui/screens/policy-detail.md#policy-heading", text="Policy PN-1001", covers=["okf:docs/features/policy/flows/create-policy.md:end:1", "okf:docs/features/policy/flows/create-policy.md:end-state", "okf:docs/features/policy/flows/create-policy.md:start:1", "okf:docs/features/policy/gui/screens/policy-detail.md#policy-heading:contract", "okf:docs/features/policy/gui/screens/policy-detail.md#policy-heading:name:1", "okf:docs/features/policy/gui/screens/policy-detail.md#policy-heading:role:1"])
    ...
    qa.verify("visible", detail, locator="../gui/screens/policy-detail.md#policy-summary", text="Draft", covers=["okf:docs/features/policy/flows/create-policy.md:end:1"])
    qa.verify("visible", heading, locator="policy-detail.md#policy-heading", text="Policy PN-1001", covers=["okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:does:1"])
    qa.verify("visible", detail, locator="policy-detail.md#policy-summary", text="Draft", covers=["okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:does:1"])
    qa.verify("created", (before, after), subject="policy pn-1001", covers=["okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:contract", "okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:does:1", "okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:when:1"])
    ...
    qa.verify("visible", detail, locator="#policy-summary", text="Draft", covers=["okf:docs/features/policy/gui/screens/policy-detail.md#policy-summary:states:1"])
    qa.verify("visible", detail, locator="#policy-summary", text="1HGCM82633A004352", covers=["okf:docs/features/policy/gui/screens/policy-detail.md#policy-summary:states:1"])
...
def refuse_policy_browser(qa: Qa) -> None:
    ...
    qa.verify("visible", qa.by_css("#vehicle_vin"), locator="#vehicle-vin-field", covers=["ac:4", "okf:docs/features/policy/gui/screens/new-policy.md#vehicle-vin-field:states:1"])
    qa.verify("visible", coverage, locator="#coverage-type-select", covers=["okf:docs/features/policy/gui/screens/new-policy.md#coverage-type-select:states:2"])
    qa.verify("visible", form, locator="#policy-form", covers=["okf:docs/features/policy/gui/screens/new-policy.md#policy-form:contract", "okf:docs/features/policy/gui/screens/new-policy.md#policy-form:keyboard:1"])
    ...
    qa.by_css("#end_date").fill("2099-12-31")
    qa.by_css("#premium").fill("1000")
    create_button = qa.by_role("button", name="Create policy")
    qa.verify("focusable", create_button, locator="#create-policy-button", activates="Enter", covers=["okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:keyboard:1", "okf:docs/features/policy/gui/screens/new-policy.md#submit-new-policy:keyboard:1"])
    ...
    qa.verify("visible", qa.by_css("#property_address"), locator="#property-address-field", covers=["ac:4", "okf:docs/features/policy/gui/screens/new-policy.md#property-address-field:states:1"])
    ...
    qa.verify("visible", form, locator="#policy-form", covers=["okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:contract", "okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:does:1", "okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:keyboard:1", "okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:when:1"])
    qa.verify("visible", error.filter(has_text="Auto coverage needs the vehicle VIN."), locator="#field-error-message", text="Auto coverage needs the vehicle VIN.", covers=["okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:contract", "okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:does:1", "okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:keyboard:1", "okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:when:1"])
    qa.verify("visible", error.filter(has_text="End date must be after the start date."), locator="#field-error-message", text="End date must be after the start date.", covers=["ac:6", "okf:docs/features/policy/gui/screens/new-policy.md#field-error-message:states:1"])
