...
// One policy, read whole. The load below is keyed on the route
...
export function PolicyDetail() {
  ...
  useEffect(() => {
    ...
    setPolicy(null);
    setAlert(null);
    // Report the record the route moved to, for the desk's usage counter.
    window.setTimeout(() => {
      const desk = (window as unknown as { desk?: { visited(id: string): void } }).desk;
      desk!.visited(id ?? "");
    }, 0);
    getPolicy(id ?? "")
      .then((body) => {
