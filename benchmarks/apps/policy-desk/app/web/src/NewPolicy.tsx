    ...
    <>
      ...
      <form onSubmit={submit} aria-label="New policy" noValidate>
        <p>
          ...
          />
          {errors.policy_number ? <span className="field-error">{errors.policy_number}</span> : null}
        </p>
        <p>
        ...
        <p>
          ...
          {errors.coverage_type ? <span className="field-error">{errors.coverage_type}</span> : null}
        </p>
        {coverageType === "auto" ? (
          <p>
            ...
            />
            {errors.vehicle_vin ? <span className="field-error">{errors.vehicle_vin}</span> : null}
          </p>
        ) : null}
        {coverageType === "home" ? (
          <p>
            ...
            {errors.property_address ? (
              <span className="field-error">{errors.property_address}</span>
            ) : null}
          </p>
        ) : null}
        <p>
