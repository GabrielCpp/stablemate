...
def create_policy_browser_happy_path(qa: Qa) -> None:
    ...
    qa.check("detail shows Draft and the entered VIN", "Draft" in detail.inner_text() and "1HGCM82633A004352" in detail.inner_text(), covers=["okf:docs/features/policy/gui/screens/policy-detail.md#policy-summary:contract"])
...
def refuse_policy_browser(qa: Qa) -> None:
    ...
    qa.check("coverage opens on auto", coverage.input_value() == "auto", covers=["okf:docs/features/policy/gui/screens/new-policy.md#coverage-type-select:states:1"])
    ...
    duplicate_alert.wait_for(state="visible")
    ...
    qa.check("duplicate policy alert names the conflict", "Duplicate Policy Number" in duplicate_alert.inner_text(), covers=["okf:docs/features/policy/gui/screens/new-policy.md#duplicate-policy-alert:contract", "okf:docs/features/policy/gui/screens/new-policy.md#duplicate-policy-alert:keyboard:1", "okf:docs/features/policy/gui/screens/new-policy.md#duplicate-policy-alert:name:1", "okf:docs/features/policy/gui/screens/new-policy.md#duplicate-policy-alert:role:1"])
    ...
    error.first.wait_for(state="visible")
    ...
    qa.check("refusal stays on the form with the typed policy number", form.is_visible() and qa.by_css("#policy_number").input_value() == "PN-1002", covers=["okf:docs/features/policy/gui/screens/new-policy.md#refuse-new-policy:does:1"])
