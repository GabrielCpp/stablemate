...
- code: `workhorse/workhorse/control.py::Request.cuts_the_turn` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::Request.to_json` @180ac129b0ca
...
- verify: json_path(path="$.path", equals="")
- code: `workhorse/workhorse/control.py::Request.from_raw` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::wait_until` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::send` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::arm` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::report_with` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::questions_with` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::armed` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::take` @180ac129b0ca
- tests: `workhorse/tests/test_control_channel.py::test_status_is_answered_under_every_wait_and_ends_none_of_them`
...
- code: `workhorse/workhorse/control.py::outstanding` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::hold` @180ac129b0ca
- tests: `workhorse/tests/test_reload_request.py::test_an_at_boundary_request_is_held_for_the_boundary_not_dropped`
...
- code: `workhorse/workhorse/control.py::answer` @180ac129b0ca
- tests: `workhorse/tests/test_reload_request.py::test_the_default_request_cuts_the_turn`
...
- code: `workhorse/workhorse/control.py::SocketChannel` @180ac129b0ca
- tests: `workhorse/tests/test_control_channel.py::test_a_message_sent_to_a_live_run_arrives_with_its_reply`
...
- code: `workhorse/workhorse/control.py::NullChannel` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::FakeChannel` @180ac129b0ca
- tests: `workhorse/tests/test_control_channel.py::test_status_is_answered_under_every_wait_and_ends_none_of_them`
...
- code: `workhorse/workhorse/control.py::ControlChannel.fileno` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::ControlChannel.take` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::ControlChannel.reply` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::ControlChannel.close` @180ac129b0ca
...
- code: `workhorse/workhorse/control.py::ControlProtocolError` @180ac129b0ca
