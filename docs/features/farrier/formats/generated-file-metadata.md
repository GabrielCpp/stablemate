...
- file: front matter of any farrier-generated `SKILL.md` / command `.md` under `.claude/`,
  `.agents/`, or `.github/`
- code: `farrier/farrier/renderer.py::skill_metadata_block` @c90fc5d746a8 — writes the block
- code: `farrier/farrier/frontmatter.py::frontmatter_metadata` @525c0e8d7c4b — parses the nested mapping
- code: `farrier/farrier/frontmatter.py::frontmatter_metadata` @525c0e8d7c4b — implementation moved from the compatibility facade; the CLI imports this parser
