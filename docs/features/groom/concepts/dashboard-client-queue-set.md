...
- refs: [run dashboard websocket session](../http/groom.md#run-dashboard-websocket-session), [dashboard websocket send loop](dashboard-websocket-send-loop.md), [dashboard shell broadcaster](dashboard-shell-broadcaster.md), [sidecar blocked applier](sidecar-blocked-applier.md), [dashboard state payload](../dashboard-state-payload.md), [run watch registry](run-watch-registry.md)
