...
- accepts: `globex/src/a.py` returns `globex/src/a.py`.
- accepts: `globex\\src\\a.py` returns `globex/src/a.py`.
- accepts: `globex/./a.py` returns `globex/./a.py`; the guard blocks traversal but does not collapse current-directory markers.
