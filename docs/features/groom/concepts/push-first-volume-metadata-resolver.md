...
- refs: [receive progress push](../http/groom.md#receive-progress-push), [receive blocked push](../http/groom.md#receive-blocked-push), [receive exited push](../http/groom.md#receive-exited-push), [sidecar hello applier](sidecar-hello-applier.md), [Docker inspection reader](docker-inspection-reader.md), [Docker inspect container object](../formats/docker-inspect-container-object.md), [workflow-container conversion](../formats/docker-inspect-container-object.md#consumer-workflow-container-conversion), [method-container-from-inspect](workflow-discovery-scan.md#method-container-from-inspect), [workflow container](workflow-container.md), [workflow registry upsert](workflow-registry.md#method-upsert-workflow)
...
- idempotency: workflow-registry — if the registry already contains a workflow record for `container_id` and its `workspace_volume` field is non-empty, the resolver returns without contacting Docker or changing any registry field.
...
- concurrency: workflow-registry — no registry lock, retry loop, deduplication of simultaneous first-sight calls, or cross-process coordination is provided.
...
- Derives: a temporary [workflow container](workflow-container.md) view from the [Docker inspect container object](../formats/docker-inspect-container-object.md), using only the discovered `workspace_volume`, `runs_volume`, and `workflow_type` fields for this resolver's write.
...
- Calls: [workflow-container conversion](../formats/docker-inspect-container-object.md#consumer-workflow-container-conversion) with the raw inspection object when metadata exists.
