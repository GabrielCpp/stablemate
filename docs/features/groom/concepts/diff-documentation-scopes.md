...
module's other endpoint handlers. Read [workspace diff data method-diff](../formats/workspace-diff-data.md#method-diff)
when the question concerns the [workspace diff data](../formats/workspace-diff-data.md) format it
