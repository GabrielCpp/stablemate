...
1. Rebuild the packet queue from current source and book; gate to the operator if the evidence is
   unreadable, or finish the run once no packets remain
