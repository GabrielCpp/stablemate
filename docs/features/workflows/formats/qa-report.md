...
- code: `workflows/src/workhorse_workflows/coder/shared/schemas/qa.py::QaReport.status` @2e918886779f
...
- verify: json_path(path="$.notes", matches=".*")
- code: `workflows/src/workhorse_workflows/coder/shared/schemas/qa.py::QaReport.notes` @2e918886779f
