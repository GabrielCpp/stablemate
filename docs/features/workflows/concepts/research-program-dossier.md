...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py` @a9c3ba187feb
...
- type: `float`
- default: `2.0`
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::K_RESOLVABLE` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::STALE_DAYS` @a9c3ba187feb

### STALE_CYCLES
- type: `int`
- default: `4`
- semantics: concluded gates (pass or kill) without metric improvement before same finding triggers
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::STALE_CYCLES` @a9c3ba187feb

### APPARATUS_CYCLES
- type: `int`
- default: `2`
- semantics: kill → revive laps on the program before apparatus malfunction counts as finding
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::APPARATUS_CYCLES` @a9c3ba187feb

### DEADLINE_DAYS
- type: `int`
- default: `45`
- semantics: days to frozen deadline under which a stale program is under pressure
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::DEADLINE_DAYS` @a9c3ba187feb

### LEAD_REVIEWS_EXHAUSTED
- type: `int`
- default: `4`
- semantics: lead reviews spent at which the loop is looping on a question its ladder cannot settle
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::LEAD_REVIEWS_EXHAUSTED` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::parse_frozen_target` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::parse_status_table` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::classify_entry` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::parse_dated_entries` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::pending_results` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::read_jobs` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::metric_series` @a9c3ba187feb
...
- verify: json_path(path="$", matches="^\\d{4}-\\d{2}-\\d{2}$")
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::last_move` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::resolvability` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::code_churn` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::count_events` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::triggers` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::fingerprint` @a9c3ba187feb
...
- verify: json_path(path="$.unparsed[0]", matches="cells")
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::build_dossier` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::render_dossier` @a9c3ba187feb
...
- code: `workflows/src/workhorse_workflows/research/nodes/dossier.py::summarize` @a9c3ba187feb
