...
- code: `workflows/src/workhorse_workflows/coder/shared/escalation.py::HISTORY_HEAD` @42d37b966a0e
...
- verify: json_path(path="$.result", matches=".*")
- code: `workflows/src/workhorse_workflows/coder/shared/escalation.py::HISTORY_TAIL` @42d37b966a0e
...
- code: `workflows/src/workhorse_workflows/coder/shared/escalation.py::compose_escalation` @42d37b966a0e
...
- verify: json_path(path="$.result", matches=".*")
- code: `workflows/src/workhorse_workflows/coder/shared/escalation.py::escalation` @42d37b966a0e
...
- verify: json_path(path="$.result", matches=".*context\\.md")
- code: `workflows/src/workhorse_workflows/coder/shared/escalation.py::context_path` @42d37b966a0e
