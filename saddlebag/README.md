...
```bash
saddlebag env set web-local VITE_FIREBASE_PROJECT_ID=globex          # argv  -> config
...
saddlebag env set web-local VITE_FIREBASE_PROJECT_ID=globex
...
entries:
  ...
  - key: VITE_FIREBASE_API_KEY
    kind: secret          # the value lives in the store, keyed globex/env-001/VITE_FIREBASE_API_KEY
