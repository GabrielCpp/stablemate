...
The skill-specific branch of [`agent-writing`](../SKILL.md): what changes when the document
...
mechanics belong to [[agent-library]] — this file covers only what bears on the writing.
...
metadata key. Edit the library source, then re-install — see [[agent-library]] for the
