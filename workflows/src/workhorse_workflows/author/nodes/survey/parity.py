...
from workhorse_workflows.author.paths import launch_repo_root
from workhorse_workflows.author.schemas.parity import ParityConfig
from workhorse_workflows.author.schemas.survey import EmitResult, Expansion
...
def load_parity_config(
    ...
    target = target.strip() or "docs/features"
...
@blueprint.node(stub=_stubs.emitted)
