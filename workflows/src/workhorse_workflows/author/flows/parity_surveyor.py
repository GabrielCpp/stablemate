...
from workhorse_workflows.author.schemas import ParityConfig, UnitAssessment
...
class ParitySurveyor(Workflow):
    ...
    #: What emission appends to, inside its generated fence.
    backlog: str = "docs/backlog.md"
    #: Read by the assessor to recognize a surface an epic already covers.
