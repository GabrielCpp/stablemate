...
```json
{"status": "defined", "supersedes_gate": "{{ gate_id }}", "direction_name": "<short name>", "core_question": "<one line, falsifiable>", "ruled_out": ["<prior dead end>"], "new_gates": ["G0", "G1"], "readme_path": "{{ program_dir }}/README.md", "progress_reset": true}
```
