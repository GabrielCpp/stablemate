...
4. tests exercise the important success, failure, and recovery paths;
5. public-package, portability, typing, security, and repository conventions still hold;
6. documentation and metadata match the shipped behavior;
7. no placeholder, bypass, omitted phase, or unsupported completion claim remains.
