...
Edit the library source instead, then regenerate:
  library/skills/stablemate/workhorse-coder-workflow/references/state-topology.md
Editable path on this machine: `farrier source .claude/skills/stablemate-workhorse-coder-workflow/references/state-topology.md`
-->
