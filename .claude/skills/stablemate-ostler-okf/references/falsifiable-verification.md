...
Edit the library source instead, then regenerate:
  library/skills/ostler/ostler-okf/references/falsifiable-verification.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-okf/references/falsifiable-verification.md`
-->
