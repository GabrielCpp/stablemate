...
Edit the library source instead, then regenerate:
  library/skills/ostler/ostler-okf/references/defect-kinds.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-okf/references/defect-kinds.md`
-->
