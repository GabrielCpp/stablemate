...
Edit the library source instead, then regenerate:
  library/skills/ostler/ostler-okf/references/node-types/interaction.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-okf/references/node-types/interaction.md`
-->
