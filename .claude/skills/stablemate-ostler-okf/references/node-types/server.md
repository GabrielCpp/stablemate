...
Edit the library source instead, then regenerate:
  library/skills/ostler/okf/references/node-types/server.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-okf/references/node-types/server.md`
-->
