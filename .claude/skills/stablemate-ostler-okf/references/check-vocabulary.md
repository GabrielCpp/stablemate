...
Edit the library source instead, then regenerate:
  library/skills/ostler/ostler-okf/references/check-vocabulary.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-okf/references/check-vocabulary.md`
-->
