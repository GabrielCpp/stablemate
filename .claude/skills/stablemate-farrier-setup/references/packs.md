...
Edit the library source instead, then regenerate:
  library/skills/farrier/farrier-setup/references/packs.md
Editable path on this machine: `farrier source .claude/skills/stablemate-farrier-setup/references/packs.md`
-->
