...
Edit the library source instead, then regenerate:
  library/skills/workhorse/workhorse-engine/references/kit-helpers.md
Editable path on this machine: `farrier source .claude/skills/stablemate-workhorse-engine/references/kit-helpers.md`
-->
