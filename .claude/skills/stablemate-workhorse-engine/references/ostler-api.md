...
Edit the library source instead, then regenerate:
  library/skills/workhorse/workhorse-engine/references/ostler-api.md
Editable path on this machine: `farrier source .claude/skills/stablemate-workhorse-engine/references/ostler-api.md`
-->
