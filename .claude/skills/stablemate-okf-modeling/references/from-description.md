...
Edit the library source instead, then regenerate:
  library/skills/stablemate/okf-modeling/references/from-description.md
Editable path on this machine: `farrier source .claude/skills/stablemate-okf-modeling/references/from-description.md`
-->
