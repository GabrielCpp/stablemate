...
Edit the library source instead, then regenerate:
  library/skills/stablemate/okf-modeling/references/from-code.md
Editable path on this machine: `farrier source .claude/skills/stablemate-okf-modeling/references/from-code.md`
-->
