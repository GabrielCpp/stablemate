...
Edit the library source instead, then regenerate:
  library/skills/stablemate/agent-writing/references/skill-mechanics.md
Editable path on this machine: `farrier source .claude/skills/stablemate-agent-writing/references/skill-mechanics.md`
-->
