...
Edit the library source instead, then regenerate:
  library/skills/stablemate/ostler-documentation/references/node-types/environment.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-documentation/references/node-types/environment.md`
-->
