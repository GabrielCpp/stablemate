...
Edit the library source instead, then regenerate:
  library/skills/stablemate/ostler/references/python-api.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler/references/python-api.md`
-->
