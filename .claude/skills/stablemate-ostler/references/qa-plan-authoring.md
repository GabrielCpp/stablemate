...
Edit the library source instead, then regenerate:
  library/skills/stablemate/ostler/references/qa-plan-authoring.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler/references/qa-plan-authoring.md`
-->
