...
Edit the library source instead, then regenerate:
  library/skills/ostler/ostler-cli/references/okf-runbook.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-cli/references/okf-runbook.md`
-->
