...
Edit the library source instead, then regenerate:
  library/skills/ostler/ostler-cli/references/qa-plan-authoring.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-cli/references/qa-plan-authoring.md`
-->
