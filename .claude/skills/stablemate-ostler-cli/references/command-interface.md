...
Edit the library source instead, then regenerate:
  library/skills/ostler/ostler-cli/references/command-interface.md
Editable path on this machine: `farrier source .claude/skills/stablemate-ostler-cli/references/command-interface.md`
-->
