...
Edit the library source instead, then regenerate:
  library/skills/stablemate/workhorse-scripting/references/kit-helpers.md
Editable path on this machine: `farrier source .claude/skills/stablemate-workhorse-scripting/references/kit-helpers.md`
-->
