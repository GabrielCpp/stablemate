...
[`../stablemate-testing-design/SKILL.md`](../stablemate-testing-design/SKILL.md) — every rule
...
- **Prefer role + accessible name** over text-content or CSS/structure locators. A CSS path pins
  ...
  [`../stablemate-ui-accessibility/SKILL.md`](../stablemate-ui-accessibility/SKILL.md)
...
It is [`../stablemate-testing-design/SKILL.md`](../stablemate-testing-design/SKILL.md) §9
