...
gosu nobody env HOME="$CLAUDE_HOME" git config --global user.email "${GIT_AUTHOR_EMAIL:-agent@globex.local}"
gosu nobody env HOME="$CLAUDE_HOME" git config --global user.name "${GIT_AUTHOR_NAME:-Globex Agent}"
