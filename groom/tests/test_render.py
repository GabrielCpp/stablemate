...
def test_repo_menu_one_entry_per_container_repo():
    ...
    html = render.render_repo_menu([(wf_a, ["globex", "api-service"]), (wf_b, [])])
    ...
    assert 'data-container="a"' in html and 'data-repo="globex"' in html
    assert 'data-label="coder-001/globex"' in html
    assert 'data-label="coder-001/api-service"' in html
